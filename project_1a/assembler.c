...
main(int argc, char **argv)
{
    ...
    address = 0;
    while ( readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2) ) {
        int opcode_instr, regA_instr, regB_instr, destReg_instr, offsetField_instr;
        ...
        int machine_code = opcode_instr | regA_instr | regB_instr | destReg_instr | offsetField_instr_u16;
